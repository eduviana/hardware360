    ...
    <div className="w-75">
      ...
      <ul className="list-group">
        <li className="list-group-item bg-light">
          Tipo: {especificaciones.tipo}{" "}
        </li>
        <li className="list-group-item">
          Insumos: {especificaciones.insumos}{" "}
        </li>
        <li className="list-group-item bg-light">
          Memoria: {especificaciones.memoria}
        </li>
        <li className="list-group-item">
          Conexión: {especificaciones.conexion}
        </li>
        <li className="list-group-item bg-light">
          Capacidad: {especificaciones.capacidad}
        </li>
        <li className="list-group-item">
        ...
        <li className="list-group-item">
          Resolución: {especificaciones.resolucion}
        </li>
        <li className="list-group-item">
          Ciclo Mensual: {especificaciones.cicloMensual}
        </li>
      </ul>
    </div>
  </div>
