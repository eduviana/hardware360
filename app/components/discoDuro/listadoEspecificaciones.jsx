    ...
    <div className="w-75">
      ...
      <ul className="list-group">
        <li className="list-group-item bg-light">
          Capacidad de almacenamiento: {especificaciones.capacidad}{" "}
        </li>
        <li className="list-group-item">
          Factor de forma: {especificaciones.factorForma}{" "}
        </li>
        <li className="list-group-item bg-light">
          Interface: {especificaciones.interface}
        </li>
        <li className="list-group-item">
          Caché: {especificaciones.cache}
        </li>
        <li className="list-group-item bg-light">
          Velocidad de transferencia: {especificaciones.velocidad}
        </li>
        <li className="list-group-item">
          Velocidad de rotación: {especificaciones.rotacion}
        </li>
      </ul>
    </div>
  </div>
